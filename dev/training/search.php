...
$sp['createdby'] = R::getCol("SELECT DISTINCT createdby FROM req WHERE createdby <> ''");
$sp['onbehalf'] = R::getCol("SELECT DISTINCT onbehalf FROM req WHERE onbehalf <> ''");
$sp['approvedby'] = R::getCol("SELECT DISTINCT approvedby FROM req WHERE approvedby <> ''");
$sp['assignedto'] = R::getCol("SELECT DISTINCT assignedto FROM req WHERE assignedto <> ''");
