...
if(array_key_exists('id', $_GET)) {
  ...
  if($rid !== 0) {
    ...
    if($status == '' or $status == 'New' or $status == 'New - Not Submitted' or $status == 'Submitted for Approval' or $status == "New Quotation" or $status == "Quotation - Pending") {
...
<div class='row'>
<div class='col-sm'>
<h4 class='text-center'><em>Training</em></h4>
</div>
</div>
<?php
...
echo "<div class='container reqsec $rstyle'>\n";
echo "<div class='row'>\n";
echo "<div class='col-sm-2 text-right labl'>Created by:</div><div class='col-sm-3 dval'>$dn</div>\n";
...
<?php
if($rid != 0) {
  echo "<div class='col-sm-4' id='dropzone'><span class='text-right dval point oi oi-paperclip' id='paperclip'></span> Attachments <span class='popchar' id='atthelp'>?</span><br><span class='medweight' id='attachments'>\n";
}
?>
</span></div>
</div>
...
<p id='lineitemmsg'>This requisition cannot be transferred to DataFlo until all line items include the type and delivery date.</p>
</div>
