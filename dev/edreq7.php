...
if($rid == 0) {
  ...
  echo "<div class='row'>\n";
  echo "<div class='col-sm-10 offset-sm-2'><button type='button' class='btn btn-sm btn-primary' name='newline'>Add Line Item</button> <a class='labl' href='import7.php?id=$rid'>Import</a>\n";
}
?>
</div>
