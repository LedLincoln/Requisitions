...
$qry = "SELECT account, COUNT(*) AS count, SUM(total) AS total FROM req WHERE account != '' AND status != 'Canceled' GROUP BY account";
  ...
  activate: function (e, ui) {
    ...
    if(ui.newHeader.length > 0) {
      ...
      if(! already_loaded[ui.newHeader[0].id] == 1) {
        ...
        var url = "getacctreqs.php";
        var pdata = {'acctnum': projnum};
