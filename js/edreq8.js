...
$("#closebtn").click(function() {
  if(linesreviewed) {
    $("#lineitemmsg").hide();
    if($("#orderedby").val() == '' || $("#orderdate").val() == '') {
      $("#confirmhead").html("Cancel Requisition");
      $("#cancelbtn").html("No");
      $("#confirmbtn").prop("data-action", "cancel");
      $("#xferdiv").hide();
      $("#confirmprompt").html("Ordered by and/or Order date are not filled in. Do you wish to cancel this requisition?");
    } else {
      $("#xferdiv").show();
      $("#confirmhead").html("Close Requisition");
      $("#confirmprompt").html("Do you wish to close this requisition?");
    ...
    $("#xferdiv").hide();
    $("#confirmbtn").prop('disabled', false);
    $("#confirmprompt").html("Line items are not complete. They must specify type and delivery date when ordered. Do you wish to cancel this requisition?");
  }
  $("#confirmdlg").modal('show');
});
...
function setAppBtns(obo) {
  if(currentuser != obo && currentuser != createdby) {
    thismax = currentusermax;
  } else {
    thismax = Math.min(currentusermax, selfapplimit);
  }
  //console.log(currentusermax, selfapplimit, thismax, obo, amt);
  if(thismax >= Number(amt)) {
    $("#selfappprompt").show();
    $("#dlgapprove").show();
    $("#approvebtn").show();
  } else {
