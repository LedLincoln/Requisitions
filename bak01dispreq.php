...
if((($status == '' or $status == 'New' or $status == 'New - Not Submitted' or $status == 'Submitted for Approval' or $status == "Quotation - Pending" or $status == "Quotation - Complete") and $dn == $createdby or $dn == $onbehalf) or in_array($dn, $approvers) or in_array_any(["Buyer","Admin"], $userroles)) {
