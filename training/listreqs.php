...
switch($gview) {
  ...
  case "8": //Closed
    $view = 8;
    array_push($coldef, ["visible" => false, "targets" => [5, 6, 7, 8]]);
    $qry = "status = 'Closed' ORDER BY id DESC";
    break;
  case "9": //All Reqs
    $view = 9;
...
<span class='dropdown'>
Filter: <input type='text' id='dtfilter'>
...
<?php
if(in_array("Admin", $userroles) || in_array("Finance", $userroles)) {
...
<table class='stripe hover' id='reqtable' data-paging='true' style='width: 100%'>
<thead>
<?php
